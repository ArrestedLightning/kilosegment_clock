...
// YOU ARE MY SUNSHINE
const uint16_t melody_sunshine[] = {
...
const uint16_t beep1[] = {
  DUR_4|NOTE_G6, END_OF_TUNE
};

const uint16_t beep2[] = {
  DUR_8|NOTE_G6, DUR_8|NOTE_G6, DUR_8|NOTE_G6, DUR_4|NOTE_G6, END_OF_TUNE
};

#define NUM_OF_MELODIES 5
const uint16_t* melodies[NUM_OF_MELODIES] = {melody_elise, melody_range, melody_sunshine, beep1, beep2};
